...
from util.util import LambdaLR, weights_init_normal, ReplayBuffer, QueueMask, mask_generator, mod_to_pil, tensor2spectral, mod_to_spectral
...
class MaskShadowHsiGANModel(BaseModel):
    ...
    def forward(self):
        ...
        self.computed_mask = mask_generator(self.real_A, self.fake_B, isHyper=True) #processing tensors for mask generation via thresholding
    ...
    def get_visuals(self, epoch_iter, epoch=0):
            ...
            if self.isTrain:
                ...
                return mod_to_pil(self.real_A, True), mod_to_pil(self.fake_B, True), mod_to_spectral(self.real_A), mod_to_spectral(self.fake_B)
    ...
    def gen_rec_success(self, epoch):
        ...
        output_image.save(py.join(self.sample_dir, 'img-reconstruction-{}.jpg'.format(epoch)))
